    ...
    //animations for each link
        navLinks.forEach((link, index) => {
            if(link.style.animation) {
                ...
                link.style.animation = `navLinkFade 0.5s ease forwards ${index / 5 + 0.5}s`; //if (on click) the links haven't done their animation, js will load the fade in animation.
            }
        });
